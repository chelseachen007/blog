...
节点与节点之间的关系通过标签的闭合辨别，比如两个相同标签的start和end内的元素都是其子元素
...
![image-20200909153229328](../leetcode/leetcode/image-20200909153229328-1599721498641.png)
